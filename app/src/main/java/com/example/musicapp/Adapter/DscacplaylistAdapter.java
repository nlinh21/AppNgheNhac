...
public class DscacplaylistAdapter extends RecyclerView.Adapter<DscacplaylistAdapter.ViewHolder>{
    Context context;
    ArrayList<Playlist> mangplaylist;

    public DscacplaylistAdapter(Context context, ArrayList<Playlist> mangplaylist) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.dong_dscacplaylist, parent, false);
